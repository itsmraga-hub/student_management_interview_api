...
import com.api.student_management.entities.GitHubUser;
import com.api.student_management.services.GitHubLookupService;
...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CompletableFuture<GitHubUser> page4 = gitHubLookupService.findUser("itsmraga-hub");
